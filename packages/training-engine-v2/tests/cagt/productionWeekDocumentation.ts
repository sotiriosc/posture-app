export const PRODUCTION_WEEK_DOCUMENTATION_FINGERPRINT =
  "4f3fd80ed3fee29cb12c88ef6dea38b6e5f70777ac4718391daa8e7548527387";

export function productionWeekDocumentationMarker(): string {
  return `<!-- PRODUCTION_WEEK_PLANNER_AND_ALLOCATION_V1:START -->
...
Combined fingerprint: \`${PRODUCTION_WEEK_DOCUMENTATION_FINGERPRINT}\`.
