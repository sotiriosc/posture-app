...
export const CATALOG_TRUNK_DECISIONS: readonly CatalogTrunkDecision[] = [
  ...
  },
  {
    ...
    primaryTrunkRole: "None; calf development is primary",
    secondaryTrunkRole: "Low upright position control",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual and mechanics classify low trunk demand.",
  },
  {
    exerciseId: "side-lying-hip-adduction",
    primaryTrunkRole: "None; hip adduction is primary",
    secondaryTrunkRole: "Low supported position control",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual under substantial lateral floor support.",
  },
  {
    exerciseId: "loop-band-lateral-walk",
    primaryTrunkRole: "None; hip abduction is primary",
    secondaryTrunkRole: "Upright lateral-step position control",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual; no loaded gait, carry, or direct trunk role is assigned.",
  },
  {
    exerciseId: "side-lying-dumbbell-external-rotation",
    primaryTrunkRole: "None modeled",
    secondaryTrunkRole: "None modeled",
    exposureClass: "NO_CURRENT_TRUNK_EVIDENCE",
    movementFunction: "No trunk contribution or role",
    evidence: "The supported cuff identity has no canonical trunk contribution.",
  },
  {
    exerciseId: "supine-hamstring-walkout",
    primaryTrunkRole: "None; knee flexion is primary",
    secondaryTrunkRole: "Pelvic position control",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual in a substantially floor-supported bridge position.",
  },
  {
    exerciseId: "wall-ankle-dorsiflexion-rock",
    primaryTrunkRole: "None modeled",
    secondaryTrunkRole: "None modeled",
    exposureClass: "NO_CURRENT_TRUNK_EVIDENCE",
    movementFunction: "No trunk contribution or role",
    evidence: "The ankle preparation identity has no canonical trunk contribution.",
  },
  {
    exerciseId: "bodyweight-hip-hinge-rehearsal",
    primaryTrunkRole: "None; hinge preparation is primary",
    secondaryTrunkRole: "Unloaded trunk organization",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual and the identity has no loaded-bracing truth.",
  },
  {
    exerciseId: "single-leg-balance-rehearsal",
    primaryTrunkRole: "None; stance control is primary",
    secondaryTrunkRole: "Upright single-leg position control",
    exposureClass: "INCIDENTAL_BRACING",
    movementFunction: "Contextual trunk contribution only",
    evidence: "Trunk is contextual and no carry, gait, march, or loaded-bracing role is assigned.",
  },
] as const;
