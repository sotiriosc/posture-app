...
export const RECOMMENDED_IMPLEMENTATION_ORDER: readonly string[] = [
  ...
  "COMPLETED REVIEW ARTIFACT: Exact seven-exercise trunk/carry curation is documented as `SEVEN_EXERCISE_TRUNK_CARRY_CURATION_READY_FOR_OWNER_APPROVAL`; production metadata remains blocked pending owner approval and contextual phase contract resolution.",
