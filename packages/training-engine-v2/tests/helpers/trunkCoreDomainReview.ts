...
export const RECOMMENDED_IMPLEMENTATION_ORDER: readonly string[] = [
  ...
  "Resolve trunk/carry pain-stress vocabulary and receiver review before any new stress tags or pain-response requirements are added.",
  "Complete exact seven-exercise owner curation and production metadata only after pain-stress review; resolve the 17 needs-review proposals before additional profiles or normalized trunk assessment features.",
