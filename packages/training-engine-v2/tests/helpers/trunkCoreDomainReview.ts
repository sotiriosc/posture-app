...
export const RECOMMENDED_IMPLEMENTATION_ORDER: readonly string[] = [
  ...
  "COMPLETED CONTRACTS: Exact seven-exercise decisions, compositional support/stance mechanics, and contextual phase resolution are implemented without adding production rows or changing production scoring; independent safety-escalation and non-diagnostic symptom-behavior/training-tolerance ownership remain required before the seven production rows.",
