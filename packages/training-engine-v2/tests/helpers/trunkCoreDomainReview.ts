...
export const RECOMMENDED_IMPLEMENTATION_ORDER: readonly string[] = [
  ...
  "Resolve the proposed trunk/carry equipment, pain/stress, prescription, provenance, and single-candidate bootstrap decisions before any catalog implementation.",
