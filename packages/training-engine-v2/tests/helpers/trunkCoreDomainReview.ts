...
export const RECOMMENDED_IMPLEMENTATION_ORDER: readonly string[] = [
  ...
  "COMPLETED REVIEW ARTIFACT: Exact seven-exercise trunk/carry owner decisions are recorded in `SEVEN_EXERCISE_TRUNK_CARRY_CURATION_READY_FOR_OWNER_APPROVAL`; production metadata remains blocked pending contextual phase contract resolution and truthful support/stance representation.",
