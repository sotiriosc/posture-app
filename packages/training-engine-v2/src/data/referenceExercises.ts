...
const REFERENCE_EXERCISE_DEFINITIONS = [
  {
    ...
    summary: generatedCoachingFallback("ninety-ninety-breathing").summary,
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("ninety-ninety-breathing").coachingFocus,
  },
  {
    id: "serratus-wall-slide",
    name: "Serratus Wall Slide",
    summary: generatedCoachingFallback("serratus-wall-slide").summary,
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("serratus-wall-slide").coachingFocus,
  },
  {
    id: "dead-bug",
    name: "Dead Bug",
    summary: generatedCoachingFallback("dead-bug").summary,
    family: "core_control",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dead-bug").coachingFocus,
  },
  {
    id: "push-up",
    name: "Push-Up",
    summary: generatedCoachingFallback("push-up").summary,
    family: "upper_push",
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("push-up").coachingFocus,
  },
  {
    id: "dumbbell-bench-press",
    name: "Dumbbell Bench Press",
    summary: generatedCoachingFallback("dumbbell-bench-press").summary,
    family: "upper_push",
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dumbbell-bench-press").coachingFocus,
  },
  {
    id: "machine-chest-press",
    name: "Machine Chest Press",
    summary: generatedCoachingFallback("machine-chest-press").summary,
    family: "upper_push",
    movementRoles: ["horizontal_push"],
    trainingRoles: ["primary_strength", "secondary_strength"],
    muscleContributions: contributions({ primary: ["chest"], keySecondary: ["triceps", "front_delts"] }),
    ...
    cautionStressTags: ["horizontal_pressing"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("machine-chest-press").coachingFocus,
  },
  {
    id: "cable-chest-fly",
    name: "Cable Chest Fly",
    summary: generatedCoachingFallback("cable-chest-fly").summary,
    family: "upper_push",
    movementRoles: ["accessory"],
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("cable-chest-fly").coachingFocus,
  },
  {
    id: "chest-supported-dumbbell-row",
    name: "Chest-Supported Dumbbell Row",
    summary: generatedCoachingFallback("chest-supported-dumbbell-row").summary,
    family: "upper_pull",
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("chest-supported-dumbbell-row").coachingFocus,
  },
  {
    id: "one-arm-dumbbell-row",
    name: "One-Arm Dumbbell Row",
    summary: generatedCoachingFallback("one-arm-dumbbell-row").summary,
    family: "upper_pull",
    movementRoles: ["horizontal_pull"],
    trainingRoles: ["primary_strength", "secondary_strength"],
    ...
    cautionStressTags: ["grip_intensive"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("one-arm-dumbbell-row").coachingFocus,
  },
  {
    id: "machine-row",
    name: "Machine Row",
    summary: generatedCoachingFallback("machine-row").summary,
    family: "upper_pull",
    movementRoles: ["horizontal_pull"],
    trainingRoles: ["primary_strength", "secondary_strength"],
    muscleContributions: contributions({ primary: ["mid_back", "lats"], keySecondary: ["rear_delts", "biceps"] }),
    ...
    cautionStressTags: ["grip_intensive"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("machine-row").coachingFocus,
  },
  {
    id: "seated-cable-row",
    name: "Seated Cable Row",
    summary: generatedCoachingFallback("seated-cable-row").summary,
    family: "upper_pull",
    movementRoles: ["horizontal_pull"],
    trainingRoles: ["primary_strength", "secondary_strength"],
    ...
    cautionStressTags: ["grip_intensive"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("seated-cable-row").coachingFocus,
  },
  {
    id: "band-row",
    name: "Band Row",
    summary: generatedCoachingFallback("band-row").summary,
    family: "upper_pull",
    movementRoles: ["horizontal_pull"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("band-row").coachingFocus,
  },
  {
    id: "dumbbell-shoulder-press",
    name: "Dumbbell Shoulder Press",
    summary: generatedCoachingFallback("dumbbell-shoulder-press").summary,
    family: "upper_push",
    ...
    cautionStressTags: ["overhead_pressing"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dumbbell-shoulder-press").coachingFocus,
  },
  {
    id: "lat-pulldown",
    name: "Lat Pulldown",
    summary: generatedCoachingFallback("lat-pulldown").summary,
    family: "upper_pull",
    ...
    cautionStressTags: ["grip_intensive"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("lat-pulldown").coachingFocus,
  },
  {
    id: "band-lat-pulldown",
    name: "Band Lat Pulldown",
    summary: generatedCoachingFallback("band-lat-pulldown").summary,
    family: "upper_pull",
    movementRoles: ["vertical_pull"],
    trainingRoles: ["activation", "hypertrophy_accessory", "secondary_strength"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("band-lat-pulldown").coachingFocus,
  },
  {
    id: "goblet-squat",
    name: "Goblet Squat",
    summary: generatedCoachingFallback("goblet-squat").summary,
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("goblet-squat").coachingFocus,
  },
  {
    id: "leg-press",
    name: "Leg Press",
    summary: generatedCoachingFallback("leg-press").summary,
    family: "squat_pattern",
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("leg-press").coachingFocus,
  },
  {
    id: "bodyweight-box-squat",
    name: "Bodyweight Box Squat",
    summary: generatedCoachingFallback("bodyweight-box-squat").summary,
    family: "squat_pattern",
    movementRoles: ["squat", "knee_dominant"],
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("bodyweight-box-squat").coachingFocus,
  },
  {
    id: "dumbbell-romanian-deadlift",
    name: "Dumbbell Romanian Deadlift",
    summary: generatedCoachingFallback("dumbbell-romanian-deadlift").summary,
    ...
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dumbbell-romanian-deadlift").coachingFocus,
  },
  {
    id: "cable-pull-through",
    name: "Cable Pull-Through",
    summary: generatedCoachingFallback("cable-pull-through").summary,
    family: "hinge_pattern",
    movementRoles: ["hinge"],
    ...
    cautionStressTags: ["loaded_hinge"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("cable-pull-through").coachingFocus,
  },
  {
    id: "split-squat",
    name: "Split Squat",
    summary: generatedCoachingFallback("split-squat").summary,
    ...
    cautionStressTags: ["deep_knee_flexion", "loaded_knee_flexion"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("split-squat").coachingFocus,
  },
  {
    id: "step-up",
    name: "Step-Up",
    summary: generatedCoachingFallback("step-up").summary,
    family: "single_leg_pattern",
    movementRoles: ["single_leg", "knee_dominant"],
    trainingRoles: ["secondary_strength", "hypertrophy_accessory"],
    ...
    cautionStressTags: ["loaded_knee_flexion"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("step-up").coachingFocus,
  },
  {
    id: "lying-leg-curl",
    name: "Lying Leg Curl",
    summary: generatedCoachingFallback("lying-leg-curl").summary,
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("lying-leg-curl").coachingFocus,
  },
  {
    id: "glute-bridge",
    name: "Glute Bridge",
    summary: generatedCoachingFallback("glute-bridge").summary,
    family: "glute_hamstring",
    movementRoles: ["accessory"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("glute-bridge").coachingFocus,
  },
  {
    id: "dumbbell-lateral-raise",
    name: "Dumbbell Lateral Raise",
    summary: generatedCoachingFallback("dumbbell-lateral-raise").summary,
    ...
    cautionStressTags: ["shoulder_abduction_external_rotation"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dumbbell-lateral-raise").coachingFocus,
  },
  {
    id: "reverse-pec-deck",
    name: "Reverse Pec Deck",
    summary: generatedCoachingFallback("reverse-pec-deck").summary,
    family: "delt_accessory",
    movementRoles: ["scapular_control"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("reverse-pec-deck").coachingFocus,
  },
  {
    id: "band-face-pull",
    name: "Band Face Pull",
    summary: generatedCoachingFallback("band-face-pull").summary,
    family: "scapular_preparation",
    movementRoles: ["scapular_control"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("band-face-pull").coachingFocus,
  },
  {
    id: "dumbbell-curl",
    name: "Dumbbell Curl",
    summary: generatedCoachingFallback("dumbbell-curl").summary,
    ...
    cautionStressTags: ["grip_intensive"],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("dumbbell-curl").coachingFocus,
  },
  {
    id: "cable-triceps-pressdown",
    name: "Cable Triceps Pressdown",
    summary: generatedCoachingFallback("cable-triceps-pressdown").summary,
    family: "arm_accessory",
    movementRoles: ["accessory"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("cable-triceps-pressdown").coachingFocus,
  },
  {
    id: "pallof-press",
    name: "Pallof Press",
    summary: generatedCoachingFallback("pallof-press").summary,
    family: "core_control",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("pallof-press").coachingFocus,
  },
  {
    id: "forearm-plank",
    name: "Forearm Plank",
    summary: generatedCoachingFallback("forearm-plank").summary,
    family: "core_control",
    movementRoles: ["anti_extension_core"],
    trainingRoles: ["activation", "hypertrophy_accessory"],
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("forearm-plank").coachingFocus,
  },
  {
    id: "forearm-side-plank",
    name: "Forearm Side Plank",
    summary: generatedCoachingFallback("forearm-side-plank").summary,
    family: "core_control",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("forearm-side-plank").coachingFocus,
  },
  {
    id: "machine-abdominal-crunch",
    name: "Machine Abdominal Crunch",
    summary: generatedCoachingFallback("machine-abdominal-crunch").summary,
    family: "core_control",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("machine-abdominal-crunch").coachingFocus,
  },
  {
    id: "half-kneeling-high-to-low-cable-chop",
    name: "Half-Kneeling High-to-Low Cable Chop",
    summary: generatedCoachingFallback("half-kneeling-high-to-low-cable-chop").summary,
    family: "core_control",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("half-kneeling-high-to-low-cable-chop").coachingFocus,
  },
  {
    id: "farmer-carry",
    name: "Farmer Carry",
    summary: generatedCoachingFallback("farmer-carry").summary,
    family: "carry_load",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("farmer-carry").coachingFocus,
  },
  {
    id: "suitcase-carry",
    name: "Suitcase Carry",
    summary: generatedCoachingFallback("suitcase-carry").summary,
    family: "carry_load",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("suitcase-carry").coachingFocus,
  },
  {
    id: "wall-supported-suitcase-march",
    name: "Wall-Supported Suitcase March",
    summary: generatedCoachingFallback("wall-supported-suitcase-march").summary,
    family: "carry_load",
    ...
    cautionStressTags: [],
    contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("wall-supported-suitcase-march").coachingFocus,
  },
  {
    id: "standing-calf-raise",
    name: "Standing Calf Raise",
    summary: generatedCoachingFallback("standing-calf-raise").summary,
    ...
    coachingFocus: generatedCoachingFallback("standing-calf-raise").coachingFocus,
  },
  {
    id: "side-lying-hip-adduction",
    name: "Side-Lying Hip Adduction",
    summary: generatedCoachingFallback("side-lying-hip-adduction").summary,
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("side-lying-hip-adduction").coachingFocus,
  },
  {
    id: "loop-band-lateral-walk",
    name: "Loop-Band Lateral Walk",
    summary: generatedCoachingFallback("loop-band-lateral-walk").summary,
    family: "hip_accessory",
    movementRoles: ["accessory"],
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("loop-band-lateral-walk").coachingFocus,
  },
  {
    id: "side-lying-dumbbell-external-rotation",
    name: "Side-Lying Dumbbell External Rotation",
    summary: generatedCoachingFallback("side-lying-dumbbell-external-rotation").summary,
    family: "cuff_control",
    movementRoles: ["accessory"],
    ...
    progression: { progressionAxes: ["load", "reps", "sets", "range", "tempo"], transitionRelationships: [] },
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("side-lying-dumbbell-external-rotation").coachingFocus,
  },
  {
    id: "supine-hamstring-walkout",
    name: "Supine Hamstring Walkout",
    summary: generatedCoachingFallback("supine-hamstring-walkout").summary,
    family: "glute_hamstring",
    movementRoles: ["accessory"],
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("supine-hamstring-walkout").coachingFocus,
  },
  {
    id: "wall-ankle-dorsiflexion-rock",
    name: "Wall Ankle Dorsiflexion Rock",
    summary: generatedCoachingFallback("wall-ankle-dorsiflexion-rock").summary,
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("wall-ankle-dorsiflexion-rock").coachingFocus,
  },
  {
    id: "bodyweight-hip-hinge-rehearsal",
    name: "Bodyweight Hip-Hinge Rehearsal",
    summary: generatedCoachingFallback("bodyweight-hip-hinge-rehearsal").summary,
    family: "hinge_pattern",
    movementRoles: ["hinge"],
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("bodyweight-hip-hinge-rehearsal").coachingFocus,
  },
  {
    id: "single-leg-balance-rehearsal",
    name: "Single-Leg Balance Rehearsal",
    summary: generatedCoachingFallback("single-leg-balance-rehearsal").summary,
    family: "single_leg_pattern",
    ...
    cautionStressTags: [], contraindicatedStressTags: [],
    coachingFocus: generatedCoachingFallback("single-leg-balance-rehearsal").coachingFocus,
  },
  {
