...
} from "./policies/longitudinalAdaptationPolicyV1";
...
export const LONGITUDINAL_ADAPTATION_ONTOLOGY_AUDIT_CLASSIFICATION =
  "LONGITUDINAL_ADAPTATION_ONTOLOGY_READY" as const;

export const LONGITUDINAL_ADAPTATION_POLICY_ID = PRODUCTION_LONGITUDINAL_ADAPTATION_POLICY_REFERENCE.policyId;
export const LONGITUDINAL_ADAPTATION_POLICY_VERSION = PRODUCTION_LONGITUDINAL_ADAPTATION_POLICY_REFERENCE.version;
export const LONGITUDINAL_ADAPTATION_POLICY_REFERENCE = PRODUCTION_LONGITUDINAL_ADAPTATION_POLICY_REFERENCE;
export const LONGITUDINAL_ADAPTATION_POLICY_PHILOSOPHY =
  PRODUCTION_LONGITUDINAL_ADAPTATION_POLICY_PHILOSOPHY;
...
LongitudinalAdaptationPolicyV1 = LONGITUDINAL_ADAPTATION_POLICY_V1_DESIGN_COMPATIBILITY_PROJECTION;
