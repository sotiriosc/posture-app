...
export const OUTCOME_SOURCE_FACT_TYPES = Object.freeze([
  ...
  "actual_side", "actual_load_not_applicable", "technique_response", "immediate_pain_response",
  "session_difficulty", "energy_readiness", "substitution", "response_tolerance", "symptom_change", "symptom_onset",
