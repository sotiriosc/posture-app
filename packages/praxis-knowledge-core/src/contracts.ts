...
export const PREPARATION_FOUNDATION_KNOWLEDGE_CONTRACT = Object.freeze({
  contractId: "PREPARATION_INTELLIGENCE_FOUNDATION_KNOWLEDGE",
  contractVersion: "1.0.0",
} as const);

export const PRODUCTION_69_KNOWLEDGE_REGISTRY_CONTRACT = Object.freeze({
  contractId: "PRODUCTION_69_EXERCISE_KNOWLEDGE_REGISTRY",
  contractVersion: "1.0.0",
} as const);
...
export type KnowledgeContractReference =
  ...
  | typeof PREPARATION_FOUNDATION_KNOWLEDGE_CONTRACT
  | typeof PRODUCTION_69_KNOWLEDGE_REGISTRY_CONTRACT
