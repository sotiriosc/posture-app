...
const rawExercises: Exercise[] = [
  ...
  },
  {
    ...
    category: "warmup",
    mobilizes: ["thoracic spine", "spine"],
  ...
  },
  {
    ...
    difficulty: 1,
    primes: ["hinge"],
    mobilizes: ["hips", "hamstrings", "lower back"],
    equipment: ["none"],
  ...
  },
  {
    ...
    difficulty: 4,
    tier: 2,
    swapOptions: ["cable-seated-row", "dumbbell-rows"],
    equipment: ["dumbbells"],
  ...
  },
  {
    ...
    pattern: "horizontal_push",
    difficulty: 3,
    swapOptions: ["dumbbell-bench-press"],
    equipment: ["dumbbells"],
    movementPattern: ["push"],
    muscleGroups: ["chest", "triceps", "shoulders"],
    painContraindications: ["shoulders", "wrists", "elbows"],
  ...
  },
  {
    ...
    difficulty: 3,
    tier: 2,
    swapOptions: ["machine-shoulder-press"],
    equipment: ["dumbbells"],
    movementPattern: ["push", "verticalpush"],
    muscleGroups: ["shoulders", "triceps", "upper chest"],
    painContraindications: ["acute shoulders", "wrists", "elbows"],
    loadType: "weighted",
    durationOrReps: "6-12 reps",
  ...
  },
  {
    ...
    category: "cooldown",
    mobilizes: ["spine", "thoracic spine"],
    equipment: ["none"],
    movementPattern: ["mobility", "spine"],
    muscleGroups: ["upper back"],
    loadType: "bodyweight",
  ...
  },
  {
    ...
    category: "activation",
    primes: ["horizontal_push", "vertical_push", "horizontal_pull"],
    mobilizes: ["shoulders", "scapulae", "thoracic spine"],
    equipment: ["none"],
    movementPattern: ["mobility", "scapular"],
    muscleGroups: ["upper back", "shoulders"],
  ...
  },
  {
    ...
    painContraindications: ["elbows", "acute neck"],
  ...
  },
  {
    ...
    painContraindications: ["knees", "hips", "ankles", "acute low back"],
    loadType: "weighted",
  ...
  },
  {
    ...
    regressionOf: "feet-elevated-pushup",
    equipment: ["none"],
    movementPattern: ["push"],
    muscleGroups: ["chest", "triceps", "shoulders"],
    painContraindications: ["wrists", "acute shoulders"],
  ...
  },
  {
    ...
    difficulty: 3,
    tier: 1,
    swapOptions: ["wall-handstand-hold"],
    equipment: ["none"],
    movementPattern: ["push", "verticalpush"],
    muscleGroups: ["shoulders", "triceps"],
    painContraindications: ["acute shoulders", "wrists", "acute neck"],
    loadType: "bodyweight",
    durationOrReps: "6-10 reps",
  ...
  },
  {
    ...
    pattern: "horizontal_push",
    familyKey: "pushup",
    variantKey: "feet_elevated",
    difficulty: 4,
    tier: 2,
    progressionOf: "pushup",
    regressionOf: "archer-pushup",
    equipment: ["none"],
    movementPattern: ["push"],
    muscleGroups: ["chest", "triceps", "shoulders", "core"],
    painContraindications: ["wrists", "shoulders"],
    loadType: "bodyweight",
    durationOrReps: "6-12 reps",
  ...
  },
  {
    ...
    pattern: "horizontal_push",
    difficulty: 1,
    regressionOf: "machine-pec-deck-press",
    painContraindications: ["shoulders", "wrists", "elbows"],
  ...
  },
  {
    ...
    pattern: "vertical_push",
    difficulty: 2,
    regressionOf: "machine-shoulder-press",
    // Free-text is load-management ("light band"), not a hard ban — acute caution only.
    painContraindications: ["acute shoulders", "wrists", "neck"],
    familyKey: "shoulder_press",
  ...
  },
  {
    ...
    tier: 1,
    equipment: ["bands"],
    // Free-text: reduce range/tension — soft acute caution, not hard questionnaire ban.
  ...
  },
  {
    ...
    phaseMin: "activation",
    difficultyTier: "easy",
    // SR-1: band variants are the low-equipment/pain lane — not progression rungs
    swapOptions: ["cable-straight-arm-pulldown"],
    equipment: ["bands"],
  ...
  },
  {
    ...
    tier: 2,
    equipment: ["dumbbells"],
    painContraindications: ["elbows", "wrists"],
  ...
  },
  {
    ...
    tier: 2,
    equipment: ["dumbbells"],
    painContraindications: ["elbows", "shoulders"],
  ...
  },
  {
    ...
    tier: 3,
    progressionOf: "suspension-row-parallel",
    regressionOf: "suspension-one-arm-row-assisted",
    equipment: ["pullup_bar", "bands"],
    movementPattern: ["pull", "horizontalpull"],
    muscleGroups: ["upper back", "lats", "rear delts"],
    painContraindications: ["shoulders", "elbows", "neck"],
  ...
  },
  {
    ...
    muscleGroups: ["lats", "upper back", "rear delts"],
    painContraindications: ["acute shoulders", "elbows", "acute neck"],
    loadType: "bodyweight",
    durationOrReps: "8-12 reps",
  ...
  },
  {
    ...
    tier: 1,
    progressionOf: "wall-pushup",
    swapOptions: ["suspension-pushup-upright"],
    equipment: ["none"],
    movementPattern: ["push", "horizontalpush"],
    muscleGroups: ["chest", "triceps", "shoulders"],
    painContraindications: ["wrists", "shoulders", "elbows"],
  ...
  },
  {
    ...
    phaseMin: "growth",
    difficultyTier: "hard",
    swapOptions: ["cable-seated-row", "single-arm-dumbbell-row", "dumbbell-rows"],
    equipment: ["dumbbells", "bench"],
    movementPattern: ["pull", "horizontalpull"],
    muscleGroups: ["upper back", "lats", "rear delts"],
    painContraindications: ["elbows", "neck"],
  ...
  },
  {
    ...
    phaseMin: "growth",
    difficultyTier: "hard",
    swapOptions: ["band-assisted-pullup"],
    equipment: ["machines"],
    movementPattern: ["pull", "verticalpull"],
    muscleGroups: ["lats", "upper back", "biceps"],
    painContraindications: ["shoulders", "elbows", "neck"],
  ...
  },
  {
    ...
    phaseMin: "activation",
    difficultyTier: "moderate",
    swapOptions: ["band-straight-arm-pulldown"],
    equipment: ["cables"],
    movementPattern: ["pull", "verticalpull", "shoulder-extension"],
    muscleGroups: ["lats", "serratus", "upper back"],
  ...
  },
  {
    ...
    painContraindications: ["acute shoulders", "acute neck"],
    loadType: "weighted",
    durationOrReps: "10-15 reps",
  ...
  },
  {
    ...
    regressionOf: "dumbbell-bench-press",
    equipment: ["machines"],
    movementPattern: ["push", "horizontalpush"],
    muscleGroups: ["chest", "triceps", "anterior delts"],
    painContraindications: ["shoulders", "wrists", "elbows"],
  ...
  },
  {
    ...
    difficultyTier: "hard",
    progressionOf: "band-chest-press",
    swapOptions: ["machine-chest-press"],
    equipment: ["machines"],
    movementPattern: ["push", "horizontalpush", "fly"],
    muscleGroups: ["chest", "anterior delts"],
    painContraindications: ["shoulders", "wrists", "elbows"],
  ...
  },
  {
    ...
    phaseMin: "growth",
    difficultyTier: "hard",
    swapOptions: ["barbell-bench-press-paused"],
    equipment: ["barbell"],
    movementPattern: ["push", "horizontalpush"],
    muscleGroups: ["chest", "triceps", "anterior delts"],
    painContraindications: ["shoulders", "wrists", "elbows"],
  ...
  },
  {
    ...
    movementPattern: ["push", "verticalpush"],
    muscleGroups: ["shoulders", "triceps", "upper chest"],
    painContraindications: ["acute shoulders", "wrists", "elbows", "acute neck"],
    loadType: "weighted",
    durationOrReps: "8-12 reps",
  ...
  },
  {
    ...
    phaseMin: "growth",
    difficultyTier: "hard",
    swapOptions: ["barbell-strict-press"],
    equipment: ["dumbbells"],
    movementPattern: ["push", "verticalpush"],
    muscleGroups: ["shoulders", "triceps", "upper chest"],
    painContraindications: ["acute shoulders", "wrists", "elbows", "acute neck"],
  ...
  },
  {
    ...
    phaseMin: "growth",
    difficultyTier: "hard",
    progressionOf: "barbell-strict-press",
    equipment: ["barbell"],
    movementPattern: ["push", "verticalpush"],
    muscleGroups: ["shoulders", "triceps", "upper chest"],
  ...
  },
  {
    ...
    movementPattern: ["squat", "kneedominant"],
    muscleGroups: ["quads", "glutes", "adductors"],
    painContraindications: ["knees", "hips", "acute low back"],
    loadType: "weighted",
    durationOrReps: "8-15 reps",
  ...
  },
  {
    ...
    painContraindications: ["knees", "hamstrings", "acute low back"],
    loadType: "weighted",
    durationOrReps: "10-15 reps",
  ...
  },
  {
    ...
    painContraindications: ["acute low back", "hamstrings", "hips"],
    loadType: "weighted",
    durationOrReps: "8-12 reps",
  ...
  },
  {
    ...
    movementPattern: ["hinge"],
    muscleGroups: ["glutes", "hamstrings", "core"],
    painContraindications: ["hips", "acute low back", "knees"],
    loadType: "weighted",
    durationOrReps: "6-12 reps",
  ...
  },
  {
    ...
    movementPattern: ["pull", "horizontalpull", "scapular"],
    muscleGroups: ["rear delts", "upper back"],
    // Free-text: acute shoulder / reduce tension — soft caution for questionnaire shoulders.
    painContraindications: ["acute shoulders", "neck"],
    loadType: "assisted",
    durationOrReps: "10-15 reps",
...
/**
 * Pattern-default pain tags for mains that omit explicit painContraindications.
 *
 * These defaults are *caution* metadata for soft policy / acute session handling.
 * Family-wide hard bans (unmodified `knees` / `low back` / `shoulders`) must be
 * authored explicitly — inferred defaults use `acute_*` so questionnaire planning
 * does not empty entire movement families when structured hard exclusion is on.
 */
const inferPainContraindicationsForExercise = (
  ...
  const byPattern: Record<string, string[]> = {
    horizontal_pull: ["acute shoulders", "elbows", "neck"],
    vertical_pull: ["acute shoulders", "elbows", "neck"],
    horizontal_push: ["acute shoulders", "wrists", "elbows"],
    vertical_push: ["acute shoulders", "wrists", "elbows"],
    knee_dominant: ["acute knees", "hips", "ankles"],
    hinge: ["acute low back", "hips"],
    core_stability: ["acute low back", "shoulders", "neck"],
  };
...
const allExercises: Exercise[] = rawExercises.map((exercise) => {
...
export { allExercises };
export const exercises: Exercise[] = allExercises.filter((e) => !e.deprecated);
...
export const exerciseById = (id?: string) => {
  ...
  return allExercises.find((exercise) => normalizeId(exercise.id) === normalized);
};
