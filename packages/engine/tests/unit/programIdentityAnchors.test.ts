...
const IDENTITY_SCENARIOS: IdentityScenario[] = [
  {
    ...
    days: [
      {
        title: "Full Body A — Squat, Press and Row",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { squat: 1, push: 1, pull: 1 },
        requiredFamilies: [
          ["squat", "single_leg_squat"],
          ["horizontal_press"],
          ["horizontal_row", "vertical_pull", "scapular_pull"],
        ],
        allowedFamilies: [
          "squat",
          "single_leg_squat",
      ...
      {
        title: "Full Body B — Hinge, Overhead and Unilateral",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { hinge: 1, squat: 1, verticalPush: 1 },
        requiredFamilies: [
          ["hinge"],
          ["squat", "single_leg_squat"],
          ["vertical_press"],
        ],
        allowedFamilies: ["hinge", "squat", "single_leg_squat", "vertical_press"],
      },
      {
        title: "Full Body C — Single-Leg, Press Variation and Lat Intent",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { squat: 1, push: 1, pull: 1 },
        requiredFamilies: [
  ...
  },
  {
    ...
    days: [
      {
        title: "Full Body A — Squat, Push and Trunk",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { squat: 1, push: 1, pull: 1 },
        requiredFamilies: [["squat"], ["horizontal_press"], ["other", "scapular_pull"]],
        allowedFamilies: ["squat", "horizontal_press", "other", "scapular_pull"],
      },
      {
        title: "Full Body B — Hinge, Single-Leg and Shoulder",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { hinge: 1, squat: 1, verticalPush: 1 },
        requiredFamilies: [["hinge"], ["single_leg_squat", "squat"], ["vertical_press"]],
        allowedFamilies: ["hinge", "single_leg_squat", "squat", "vertical_press"],
      },
      {
        title: "Full Body C — Single-Leg, Push Variation and Back Intent",
        mainCount: 3,
        accessoryCount: 2,
        lanes: { squat: 1, push: 1, pull: 1 },
        requiredFamilies: [
