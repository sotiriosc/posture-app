# Controlled Product Shadow Failure Isolation
...
The Product sync succeeds before notification. Shadow endpoint, V2, database, observability, comparison, timeout, and migration failures cannot fail or delay the completed Product operation.
