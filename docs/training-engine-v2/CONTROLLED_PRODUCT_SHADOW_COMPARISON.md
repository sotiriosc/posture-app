# Controlled Product Shadow Comparison
...
Comparison is structural and causal, uses Gate 14-compatible projections where possible, and reports incomplete alignment honestly. It has no weighted better score, diversity quota, or outcome superiority claim.
