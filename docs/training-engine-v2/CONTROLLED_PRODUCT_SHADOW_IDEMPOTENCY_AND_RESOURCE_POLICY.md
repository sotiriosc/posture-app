# Controlled Product Shadow Idempotency AND Resource Policy
...
Athlete-scoped advisory locks and unique keys return exact prior results or reject semantic conflicts. Window, concurrency, pending, snapshot, session, log, search, and wall-clock limits fail closed.
