# Controlled Product Shadow Equipment Mapping
...
bodyweight and explicit dumbbells are known. Bands do not imply an anchor, dumbbells do not imply a bench, and gym does not imply universal capability. Unknown is never promoted to absent or fully equipped.
