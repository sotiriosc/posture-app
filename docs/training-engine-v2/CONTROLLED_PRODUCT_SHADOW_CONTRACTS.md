# Controlled Product Shadow Contracts
...
All integration, trigger, source, Horizon, projection, identity-map, run, comparison, rollout, and minimization contracts are pinned to 1.0.0. Unsupported trigger/run versions fail closed.
