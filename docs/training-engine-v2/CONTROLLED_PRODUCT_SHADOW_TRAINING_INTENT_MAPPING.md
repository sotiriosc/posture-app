# Controlled Product Shadow Training Intent Mapping
...
build maps to developmental context; maintain requires an explicit maintenance policy; rehab maps only to non-diagnostic pain-aware-return context.
