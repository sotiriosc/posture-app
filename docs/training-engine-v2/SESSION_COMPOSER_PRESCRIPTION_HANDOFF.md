...
`SessionPrescriptionHandoff` carries exercise, phase, section, role, satisfied needs, continuity/progression refs, execution-blocking resolution IDs, potential structured stress, explicit requirement refs, ordering constraints, and one expected source exposure event.
