# Controlled Product Shadow Route
...
Consumer and gyms expose thin POST handlers backed by one shared server service. Authentication and allowlist evaluation precede request parsing and database creation; responses are empty and no shadow artifact reaches the browser.
