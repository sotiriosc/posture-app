...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 90/90 Breathing | Breathing / ribcage-pelvis position | Anti-extension position control | DIRECT_DEVELOPMENTAL | breathing high; anti-extension low; loaded bracing none; gait transfer none; four functions unknown; evidence: Owner-reviewed profile cites explicit roles, trunk primary, floor/supine support, and low trunk_control. | none/low | tempo, range | none | roles=preparation, recovery; sections=warmup:excellent, cooldown:good | phase_1:excellent, phase_2:good, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Dead Bug | Anti-extension control | Ribcage-pelvis coordination is plausible but not separately typed | DIRECT_DEVELOPMENTAL | anti-extension high; loaded bracing none; gait transfer none; five functions unknown; evidence: Owner-reviewed profile cites core_control, anti_extension_core, trunk primary, floor/supine support, and moderate trunk_control. | limited/low | range, tempo, complexity | none | roles=activation, hypertrophy_accessory; sections=activation:excellent, accessory:good | phase_1:excellent, phase_2:good, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Push-Up | None; horizontal push is primary | Anti-extension plank control | MEANINGFUL_SECONDARY | anti_extension_core (typed secondary role); evidence: Trunk is secondary and trunk_control is moderate. | moderate/moderate | reps, sets, tempo, support_reduction | horizontal_pressing, wrist_extension_loading | roles=primary_strength, secondary_strength, hypertrophy_accessory; sections=main:good, accessory:good | phase_1:possible, phase_2:good, phase_3:possible | Coarse trunk muscle exposure is representable; secondary/direct distinction and receiver are absent. |
| One-Arm Dumbbell Row | None; horizontal pull is primary | Loaded bracing / anti-rotation candidate (needs review) | MEANINGFUL_SECONDARY | High generic trunk control; specific function not typed; evidence: Trunk is secondary and trunk_control is high in an unsupported unilateral setup. | high/high | load, reps, sets, tempo | grip_intensive | roles=primary_strength, secondary_strength; sections=main:good, accessory:good | phase_1:possible, phase_2:good, phase_3:excellent | Coarse trunk muscle exposure is representable; secondary/direct distinction and receiver are absent. |
...
| Pallof Press | Anti-rotation control | Standing position / hip contribution | DIRECT_DEVELOPMENTAL | anti-rotation high; controlled rotation none; gait transfer none; five functions unknown; evidence: Owner-reviewed profile cites core_control, anti_rotation_core, trunk primary, standing support, and high trunk_control. | moderate/moderate | load, reps, tempo, stability | none | roles=activation, hypertrophy_accessory; sections=activation:excellent, accessory:good | phase_1:excellent, phase_2:good, phase_3:good | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Forearm Plank | Anti-extension control | Upper-limb support control | DIRECT_DEVELOPMENTAL | anti-extension high; loaded bracing none; evidence: Owner-reviewed anti-extension role, complete trunk profile, and forearm-support identity. | limited/moderate | duration, lever, support_reduction, effort | none | roles=activation, hypertrophy_accessory; sections=activation:excellent, accessory:good | phase_1:good, phase_2:possible, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Forearm Side Plank | Anti-lateral-flexion control | Side-specific upper-limb support control | DIRECT_DEVELOPMENTAL | anti-lateral-flexion high; loaded bracing none; evidence: Owner-reviewed anti-lateral role, side-support mechanics, and intrinsic lateral trunk exposure. | limited/moderate | duration, lever, support_reduction, load, effort | none | roles=activation, hypertrophy_accessory; sections=activation:excellent, accessory:good | phase_1:good, phase_2:possible, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Machine Abdominal Crunch | Controlled trunk flexion | None | DIRECT_DEVELOPMENTAL | controlled flexion high; evidence: Owner-reviewed trunk-flexion role, machine-guided mechanics, and intrinsic loaded-flexion exposure. | high/high | load, reps, sets, range, tempo | none | roles=hypertrophy_accessory, secondary_strength; sections=accessory:excellent | phase_1:possible, phase_2:possible, phase_3:good | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Half-Kneeling High-to-Low Cable Chop | Controlled trunk rotation | Half-kneeling position control | DIRECT_DEVELOPMENTAL | controlled rotation high; anti-rotation none; evidence: Owner-reviewed trunk-rotation role, high-cable path, and intrinsic loaded-rotation exposure. | moderate/moderate | load, reps, sets, range, tempo | none | roles=activation, hypertrophy_accessory, secondary_strength; sections=activation:good, accessory:excellent | phase_1:possible, phase_2:good, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Farmer Carry | Loaded bracing and gait/load transfer | Grip and whole-body capacity | DIRECT_DEVELOPMENTAL | loaded bracing high; gait/load transfer high; evidence: Owner-reviewed carry and loaded-bracing roles with intrinsic loaded gait and grip loading. | high/high | load, distance, trips, duration, effort | none | roles=capacity, hypertrophy_accessory, secondary_strength; sections=main:good, accessory:good | phase_1:possible, phase_2:good, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Suitcase Carry | Loaded bracing and anti-lateral-flexion control | Unilateral gait/load transfer and grip capacity | DIRECT_DEVELOPMENTAL | anti-lateral-flexion high; loaded bracing high; gait/load transfer high; evidence: Owner-reviewed unilateral carry identity with intrinsic gait, grip, and lateral trunk loading. | high/high | load, distance, trips, duration, effort | none | roles=capacity, hypertrophy_accessory, secondary_strength; sections=main:good, accessory:good | phase_1:possible, phase_2:good, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
| Wall-Supported Suitcase March | Support-modified loaded bracing | Stationary loaded-march capacity | DIRECT_DEVELOPMENTAL | loaded bracing moderate; no accepted gait/load-transfer claim; evidence: Owner-reviewed loaded-bracing role with intrinsic loaded march and no carry, gait, distance, or anti-lateral role truth. | moderate/moderate | load, steps, duration, support_reduction, effort | none | roles=activation, capacity; sections=activation:excellent, accessory:good | phase_1:good, phase_2:possible, phase_3:possible | Contract can name trunk + current role, but no implemented receiver computes direct credit. |
...
| Controlled rotation | trunk_rotation role plus optional controlledRotationContribution evidence | No positive expression; Pallof has reviewed none because it resists rotation | Band/Cable Woodchop with metadata caveats | Only generic trunk muscle/region signals | Movement role is typed; no ledger receiver | No reviewed rotation candidate or normalized assessment feature | Catalog + assessment |
| Loaded bracing | loaded_bracing role plus optional loadedBracingContribution evidence | Several compounds have moderate/high demand but no loaded_bracing role | Compounds, brace marches, carries | Generic trunk_control demand/capability comparison | At most coarse trunk muscle exposure; no secondary lane | No reviewed positive loaded-bracing profile, direct-role candidate, or secondary ledger lane | Catalog + ledger; role only when bracing is the selection purpose |
| Loaded gait / carries | carry role, capacity TrainingRole, and optional gaitLoadTransferContribution evidence | Farmer and suitcase carry plus three capacity-role exercises | Farmer, suitcase, band/dumbbell march and supported regressions | carry is not classified as a direct trunk role today | movementExposure can name carry; no receiver or prescription units | No catalog, laterality, gait, grip, shoulder, fatigue, or dose contract | Catalog + prescription + Composer + ledger |
...
Implementation status: **FIRST_TRUNK_PROFILE_TRANCHE_IMPLEMENTED**.
