# Controlled Product Shadow Experience Mapping
...
Beginner, Intermediate, and Advanced map exactly to V2 experience values. Unknown values fail to mapping_required.
