# PRODUCTION LONGITUDINAL EVIDENCE WINDOW
...
Windows require explicit start, end, and evaluation times. Future evidence is invalid; superseded evidence is visible but nonauthoritative.
