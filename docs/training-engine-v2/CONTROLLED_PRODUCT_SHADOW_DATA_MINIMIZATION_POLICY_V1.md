# Controlled Product Shadow Data Minimization Policy V1
...
Persisted records contain athlete-scoped IDs, immutable revisions, structured mappings/references, resource traces, failures, comparisons, and audit. Raw Product snapshots, email, notes, photos, free text, tokens, and request headers are excluded.
