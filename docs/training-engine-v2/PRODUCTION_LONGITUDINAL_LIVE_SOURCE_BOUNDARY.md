# PRODUCTION LONGITUDINAL LIVE SOURCE BOUNDARY
...
Live Performance, Response, adherence, recovery, clinical, and equipment adapters remain unimplemented. Caller-validated records are the only input.
