...
`TrainingResponseHistory` is also not a score component. One observed response belongs to one realized prescription/exposure and cannot become a permanent exercise penalty, stress intolerance, family ban, or proof that every future realization is tolerated. The deterministic ledger exposes evidence for future reviewed receivers without selecting a score or action.
