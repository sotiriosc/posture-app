...
## Pre-G3 Session Practice remaining-Week boundary

The bridge can describe unperformed required responsibility after a practice attempt, but the handoff has no scheduling or allocation authority. Existing Week planning, materialization, and reallocation behavior remain frozen.
