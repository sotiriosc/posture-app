# Controlled Product Shadow Rollout Policy V1
...
The only modes are off, capture-only internal allowlist, evaluate internal allowlist, and replay-only. Default is off; there is no all-user, percentage, random, anonymous, plan-tier, pain-based, admin, or adaptive-flag eligibility.
