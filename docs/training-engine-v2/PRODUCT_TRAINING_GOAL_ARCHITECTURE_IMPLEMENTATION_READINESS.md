...
Pre-G2L completes standard-commercial-gym foundations and typed incline/Pull-Up realizations without changing Product architecture. Session Practice Options V2 is the exact next dependency.
