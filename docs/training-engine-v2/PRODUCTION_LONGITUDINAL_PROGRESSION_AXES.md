# PRODUCTION LONGITUDINAL PROGRESSION AXES
...
Progression requires readiness, repeated success, target, quality, tolerance, recovery, Safety, legality, availability, and one policy-resolved axis.
