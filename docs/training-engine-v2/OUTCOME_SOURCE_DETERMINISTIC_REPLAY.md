# OUTCOME SOURCE DETERMINISTIC REPLAY
...
240 immutable histories rebuild active revisions, snapshots, kernel decisions, and directives byte-equivalently. Failure count: `0`; duplicate decisions: `0`; applications: `0`. Policy/time are explicit and replay never reapplies.
