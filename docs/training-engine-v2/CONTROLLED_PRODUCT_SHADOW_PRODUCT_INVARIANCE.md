# Controlled Product Shadow Product Invariance
...
Legacy Program, ProgramProgress, SessionRecord, ExerciseLog, sync request/response, offline queue, navigation, and adaptation preview remain equal. Shadow output is neither rendered nor returned.
