# Controlled Product Shadow Goal Mapping
...
Improve posture and General fitness map directly. Reduce pain maps to posture/movement plus non-diagnostic pain-aware context. Athletic performance is under-specified and unknown values require mapping.
