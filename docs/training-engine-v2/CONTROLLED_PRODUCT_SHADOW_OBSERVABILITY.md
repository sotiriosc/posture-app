# Controlled Product Shadow Observability
...
The service emits sanitized caller-hook events and persists structured audit. No raw Product payload is logged; aggregate metrics have no athlete-level Program payload and no better-Program score.
