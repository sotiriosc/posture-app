# PRODUCTION LONGITUDINAL ADAPTATION KERNEL CONTRACT
...
The public V1 contract is pure, deterministic, fail-stop, versioned, CAGT-free, and rejects unsupported versions.
