# PRODUCTION LONGITUDINAL SOURCE REVISION CONTRACT
...
Stable source identity, immutable based-on revisions, visible history, and exactly one active final revision are mandatory.
