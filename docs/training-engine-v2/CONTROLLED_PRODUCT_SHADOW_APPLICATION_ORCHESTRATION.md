# Controlled Product Shadow Application Orchestration
...
Orchestration can validate an unapplied counterfactual only. Product, Prescription, Candidate replacement, rotation, Week, deload, and Phase application counts remain zero.
