# Adaptation Application Persistence
...
Migration: `002_adaptation_application_orchestration_v1@1.0.0`. Six append-only tables persist request/revision, preconditions, owner result, shadow candidate, validation, attempt, and audit in one transaction. No Product table is read or written.
