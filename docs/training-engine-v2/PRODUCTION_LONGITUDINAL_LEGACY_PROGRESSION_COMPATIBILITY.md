# PRODUCTION LONGITUDINAL LEGACY PROGRESSION COMPATIBILITY
...
ProgressionDecision is a compatibility-only projection and has no production decision authority.
