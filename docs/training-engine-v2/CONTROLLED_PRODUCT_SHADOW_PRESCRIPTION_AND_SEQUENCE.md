# Controlled Product Shadow Prescription AND Sequence
...
Complete status requires explicit final Prescription and Sequence artifact references. Legacy doses or session ordering never fabricate those revisions.
