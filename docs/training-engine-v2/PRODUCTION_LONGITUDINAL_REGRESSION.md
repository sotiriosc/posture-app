# PRODUCTION LONGITUDINAL REGRESSION
...
Regression requires repeated local failure/adversity and one legal local axis. One failed set, missed session, label, date, or phase is insufficient.
