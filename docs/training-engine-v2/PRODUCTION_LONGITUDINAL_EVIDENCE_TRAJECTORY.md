# PRODUCTION LONGITUDINAL EVIDENCE TRAJECTORY
...
The trajectory is ordered by explicit evidence time and identity with no weighted score or arbitrary trend line.
