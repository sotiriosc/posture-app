# Controlled Product Shadow Counterfactual Boundary
...
The hard validator rejects Program, Prescription, Sequence, completion, tolerance, adaptation, and superiority misattribution. Shadow performance and outcome-attribution counters are structurally zero.
