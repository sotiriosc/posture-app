# Controlled Product Shadow Product State Revision
...
Semantic state fingerprints include structured Product facts and server revision references. Presentation titles, names, notes, cues, rationale, summaries, and creation/update prose are excluded from semantic Program identity.
