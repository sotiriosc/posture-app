# PRODUCTION LONGITUDINAL EVIDENCE APPLICABILITY
...
Applicability is exact, then related with typed differences, then identity context. Weaker evidence cannot silently override stronger evidence.
