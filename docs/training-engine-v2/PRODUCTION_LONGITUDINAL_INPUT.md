...
Input requires explicit production contract, policy, source snapshot, ledger, target, identities, windows, upstream facts, domain traces, time, and attempt.
