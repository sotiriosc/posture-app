# PRODUCTION LONGITUDINAL APPLICATION VALIDATION
...
Optional caller-generated applications are checked for persistence, rightful owner, locality, erasure, and scope excess. The kernel generates none.
