...
Event time, timezone, ingestion time, correction time, applies-through time, and evaluation time are separate facts. Late evidence permits a deterministic rebuild only; it does not apply a decision. Future evidence is invalid, and opportunity order is not a timestamp.
