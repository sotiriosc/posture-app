# PRODUCTION LONGITUDINAL THREAD STATE DECISION IDENTITY
...
Thread, state, decision, and directive identities derive from semantic lineage, never action outcome, clock, labels, count, or randomness.
