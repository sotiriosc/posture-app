# PRODUCTION LONGITUDINAL ROTATION REVIEW
...
Rotation is bounded to eligible non-anchors with preference or plateau evidence and an equivalent pool. No novelty quota exists.
