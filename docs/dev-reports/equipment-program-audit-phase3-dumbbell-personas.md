...
## Beginner three-day dumbbells / activation
...
- Main exercises recognizable without external research?
- Pulling represented honestly (no false vertical pull)?
- Hinge truthful or pain-aware hip-extension surrogate?
- Session simple to follow with confirmed equipment?
- Pain adaptation retains a meaningful workout (if pain case)?
- Next phase feels like progression rather than randomization?

## Intermediate three-day dumbbells / activation

- Id: `db_3d_intermediate_p1`
- Primary mode: dumbbells
- Structural score: 100/100
- Full-experience score (includes deferred coaching gaps): 86/100
- Hard failures: none
- Deferred experience gaps: 28 (demo/cues/progression-link metadata)
...
## Advanced three-day dumbbells / activation

- Id: `db_3d_advanced_p1`
- Primary mode: dumbbells
- Structural score: 100/100
- Full-experience score (includes deferred coaching gaps): 84/100
- Hard failures: none
- Deferred experience gaps: 32 (demo/cues/progression-link metadata)
...
## Four-day dumbbells / skill

- Id: `db_4d_intermediate_p2`
- Primary mode: dumbbells
- Structural score: 100/100
- Full-experience score (includes deferred coaching gaps): 82.5/100
- Hard failures: none
- Deferred experience gaps: 35 (demo/cues/progression-link metadata)
...
## Five-day dumbbells / growth

- Id: `db_5d_advanced_p3`
- Primary mode: dumbbells
- Structural score: 100/100
- Full-experience score (includes deferred coaching gaps): 75/100
- Hard failures: none
- Deferred experience gaps: 52 (demo/cues/progression-link metadata)
...
### Full Body B — Hinge, Overhead and Unilateral
- Mains:
  - `dumbbell-sumo-rdl` Dumbbell Sumo RDL | slot=mainHingePrimary | lane=hinge
  - `split-squat` Split Squat | slot=mainUnilateralLowerLoaded | lane=squat
  - `dumbbell-shoulder-press` Dumbbell Shoulder Press | slot=mainVerticalPushPrimary | lane=verticalPush
  - `dumbbell-rows` Dumbbell Rows | slot=mainPullHorizontal | lane=pull
...
## Confirmed-bench dumbbells / skill

- Id: `db_3d_bench_confirmed_p2`
- Primary mode: dumbbells
- Structural score: 100/100
- Full-experience score (includes deferred coaching gaps): 86.5/100
- Hard failures: none
- Deferred experience gaps: 27 (demo/cues/progression-link metadata)
...
## Shoulder-pain dumbbells / activation
...
## Low-back-pain dumbbells / activation
...
- Mains:
  ...
  - `dumbbell-reverse-lunge` Dumbbell Reverse Lunge | slot=mainUnilateralLowerLoaded | lane=squat
  - `dumbbell-shoulder-press` Dumbbell Shoulder Press | slot=mainVerticalPushPrimary | lane=verticalPush
- Accessories: prone-elbow-row, side-plank
...
## Beginner three-day dumbbells / skill
...
## Beginner three-day dumbbells / growth
