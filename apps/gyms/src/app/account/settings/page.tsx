                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      setMessage(null);
                      try {
                        // Phase 6f, Commit 1 (SR-6f) — porting Phase 6e's
                        // consumer fix: this button's copy promises a full
                        // device wipe; `resetAllAppData` only clears a
                        // hardcoded key subset, which left stray local data
                        // behind. `eraseAllLocalData` is the primitive that
                        // actually matches the copy.
