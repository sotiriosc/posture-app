...
const preview: ControlledOwnerV2ProgramPreview = {
  ...
  productProjection: {
    ...
    sessions: [{ sessionId: "owner-session:visual-1", opportunityId: "owner-opportunity-1",
      purpose: "strength_development", durationStatus: "bounded", durationMinutes: null,
      availableMinutes: 90, calculatedDuration: { status: "fits_known_bound",
        knownLowerBoundSeconds: 2_400, knownUpperBoundSeconds: 3_600,
        lowerBoundSeconds: 2_400, upperBoundSeconds: 3_600, completeness: "complete",
        unknownComponents: [], policyRefs: ["SESSION_DURATION_FEASIBILITY_POLICY_V1@1.0.0"],
      ...
      durationResolution: { status: "duration_within_capacity", rebuildCount: 0,
        structuralIterationBound: 0, intentStateFingerprints: ["visual-intent-1"] },
    ...
    { sessionId: "owner-session:visual-2", opportunityId: "owner-opportunity-2",
      ...
      durationResolution: { status: "duration_within_capacity", rebuildCount: 0,
        structuralIterationBound: 0, intentStateFingerprints: ["visual-intent-2"] },
