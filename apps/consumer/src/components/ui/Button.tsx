...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    "min-h-11 border-slate-400/35 bg-slate-900/45 text-slate-300 shadow-[0_8px_24px_rgba(0,0,0,0.2)] hover:-translate-y-px hover:bg-slate-800/55 hover:shadow-[0_12px_30px_rgba(0,0,0,0.26)] focus-visible:ring-2 focus-visible:ring-slate-300/60 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950",
  ghost:
    "min-h-11 border-transparent bg-transparent text-slate-300 hover:-translate-y-px hover:border-slate-300/35 hover:bg-slate-900/35 hover:text-white focus-visible:ring-2 focus-visible:ring-slate-300/60 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950",
  danger:
