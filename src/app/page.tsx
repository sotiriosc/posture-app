  ...
  return (
    <div className="hero-bg min-h-screen text-white">
      <div className="ui-shell flex max-w-7xl flex-col py-8 sm:py-12 lg:py-16">
        ...
        <main className="flex flex-1 flex-col items-center justify-center gap-8 py-12 sm:gap-10 lg:py-16">
          <section
          ...
          <section className="ui-soft-surface mx-auto w-full max-w-5xl rounded-lg px-4 py-5 sm:px-5">
