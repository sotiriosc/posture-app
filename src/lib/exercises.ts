...
const rawExercises: Exercise[] = [
  ...
  },
  {
    ...
    contraindications: ["Acute shoulder pain (reduce range)", "Elbow irritation (lighten load)"],
  ...
  },
  {
    ...
    contraindications: ["Acute shoulder pain (reduce range)", "Low-back flare (brace and lighten load)"],
